...
export default function Programs() {
  ...
  const fetchTherapies = async () => {
    try {
      ...
      console.log("fetchTherapies error", err)
    }
  }
    ...
    <>
          ...
          <CTableBody>
            {filteredList.length === 0 ? (
              ...
              filteredList.map((item, index) => (
                <CTableRow key={item.id} className="pg-tr">
                  ...
                  <CTableDataCell className="pg-td">
                    <span className="pg-count-badge">{item.theraphyCount} therapies</span>
                  </CTableDataCell>
      ...
      >
        ...
        <CModalBody className="pg-modal-body pg-view-body">
          {viewLoading ? (
            <LoadingIndicator message="Loading program details..." />
          ) : viewData ? (
            <>
              {/* Summary cards */}
              <div className="pg-summary-grid">
                ...
                <div className="pg-summary-card">
                  ...
                  <span className="pg-summary-value">
                    {viewData.therophyData?.length || 0}
                  </span>
                </div>
              </div>
                    ...
                    <div className="pg-acc-item" key={therapy.id || index}>
                      <details>
                        <summary className="pg-acc-head">
                          <span>{index + 1}. {therapy.therapyName}</span>
                          <span className="pg-acc-meta">
                            {therapy.exercises?.length || 0} exercise{therapy.exercises?.length !== 1 ? "s" : ""}
                        ...
                        <div className="pg-acc-body">
                          {therapy.exercises?.length > 0 ? (
                            ...
                            <div className="pg-no-data">No exercises available for this therapy</div>
                          )}
                        </div>
                      </details>
                    </div>
              ...
              <div style={{ display: "flex", justifyContent: "flex-end", marginTop: "16px" }}>
                <button className="pg-btn-secondary" onClick={() => setViewModal(false)}>
                  Close
                </button>
              </div>
            </>
      ...
      <style>{`
        ...
        .pg-acc-item details > summary {
          list-style: none;
        }
        .pg-acc-item details > summary::-webkit-details-marker {
          display: none;
        }
        .pg-acc-head {
          display: flex;
        ...
        details[open] > summary .pg-acc-arrow {
